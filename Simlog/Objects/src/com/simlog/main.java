...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.simlog", "com.simlog.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.simlog", "com.simlog.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.simlog.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
vis = vis | (forgotpasswoord.mostCurrent != null);
vis = vis | (home.mostCurrent != null);
vis = vis | (newbarangexisting.mostCurrent != null);
vis = vis | (permintaanbarang.mostCurrent != null);
vis = vis | (listpermintaanbarang.mostCurrent != null);
vis = vis | (pengadaanbarang.mostCurrent != null);
vis = vis | (trackingstatus.mostCurrent != null);
return vis;}
...
public ResumableSub_Activity_Create(com.simlog.main parent,boolean _firsttime) {
this.parent = parent;
this._firsttime = _firsttime;
}
com.simlog.main parent;
boolean _firsttime;
String _permission = "";
...
//for
this.state = 8;
group1 = new Object[]{(Object)(parent._rp.PERMISSION_WRITE_EXTERNAL_STORAGE)};
index1 = 0;
...
this.state = -1;
;
 //BA.debugLineNum = 42;BA.debugLine="Activity.LoadLayout(\"Splash\")";
parent.mostCurrent._activity.LoadLayout("Splash",mostCurrent.activityBA);
 //BA.debugLineNum = 43;BA.debugLine="Timer1.Initialize(\"Timer1\",3000)";
parent._timer1.Initialize(processBA,"Timer1",(long) (3000));
...
forgotpasswoord._process_globals();
home._process_globals();
newbarangexisting._process_globals();
permintaanbarang._process_globals();
listpermintaanbarang._process_globals();
pengadaanbarang._process_globals();
trackingstatus._process_globals();
...
_timer1 = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 24;BA.debugLine="Private rp As RuntimePermissions";
...
public static String  _timer1_tick() throws Exception{
 ...
 //BA.debugLineNum = 56;BA.debugLine="Timer1.Enabled=False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 57;BA.debugLine="StartActivity(Login)";
